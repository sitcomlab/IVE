...
var query_search_videos_by_location = fs.readFileSync(__dirname + '/../../queries/videos/search_by_location.cypher', 'utf8').toString();
...
exports.request = function(req, res) {
    ...
    async.waterfall([
        ...
        function(callback) { // Find entries
            session
                .run(query_search_videos_by_location, {
                    location_id: req.params.location_id,
