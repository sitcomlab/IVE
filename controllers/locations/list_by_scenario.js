...
var query_list_locations_by_scenario_filtered_by_location_type = fs.readFileSync(__dirname + '/../../queries/locations/list_by_scenario_filtered_by_location_type.cypher', 'utf8').toString();
...
exports.request = function(req, res) {
    ...
    async.waterfall([
        ...
        function(callback){ // Prepare query and parameters
            var query = query_list_locations_by_scenario;
            var params = {
                scenario_id: req.params.scenario_id,
            ...
            if(req.query.location_type){
                query = query_list_locations_by_scenario_filtered_by_location_type;
